...
<html lang="en">
  ...
  <div class="d-flex justify-content-start">
    ...
    <div class="text-center"><img width="100" src="<?php if(is_file("image/".$vfoto)) { echo "image/".$vfoto; } else { ?>user 1.png<?php } ?>" alt=""></div>
      <div class="text-center mt-3">Ubah Profil</div>
  <div class="container">
  ...
  <label for="floatingSelect">Jenis Kelamin</label>
      ...
      <div class="form-floating mt-3">
        <input type="date"  name="ttanggal_lahir"  class="datepicker form-control" value="<?=@$vtanggallahir?>" id="floatingInput" placeholder="name@example.com">
